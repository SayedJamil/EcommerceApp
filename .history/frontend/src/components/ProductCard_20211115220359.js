function ProductCard({name,imgUrl,price,desci}) {
    return (
        <div>
            <div class="card">
                <img src="https://cdn.dxomark.com/wp-content/uploads/medias/post-74840/samsunggalaxys21ultra5g.jpg" class="card-img-top productCardImage" alt="..." />
                <div class="card-body">
