                        ...
                        >
                            ...
                            <Modal.Body>
                                <Form>
                                    ...
                                    <Form.Text className="text-muted">
                                        Already a user? <Button variant="link">SignIn</Button>.
                                    </Form.Text>
                                </Form>
                            </Modal.Body>
                            <Modal.Footer>
                                ...
                                <Button variant="primary" onClick={handleRegisterShow}>Understood</Button>
                            </Modal.Footer>
                        </Modal>
                        <Modal
                            show={registerShow}
                        ...
                        >
                            ...
                            <Modal.Body>
                                <Form>
                                    ...
                                    <Form.Text className="text-muted">
                                        New user? <Button variant="link">SignIn</Button>.
                                    </Form.Text>
                                </Form>
                            </Modal.Body>
                            <Modal.Footer>
