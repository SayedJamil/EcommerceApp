            ...
            <nav class="navbar navbar-light navbarColor">
                <div class="container-fluid">
                    ...
                    <div class="headerRight">
                        ...
                        <h5>()items</h5>
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-circle iconColor me-1" viewBox="0 0 16 16" data-bs-toggle="modal" data-bs-target="#exampleModal">
