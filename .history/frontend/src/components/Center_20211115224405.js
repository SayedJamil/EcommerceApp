...
function Center() {
    ...
    const getData = async () => {
        await fetch("https://amazon24.p.rapidapi.com/api/product?keyword=electronics&country=US&page=1&filter=aHR0cHM6Ly93d3cuYW1hem9uLmNvbS9zP2s9aXBob25lJnJoPXBfbl9jb25kaXRpb24tdHlwZSUzQVVzZWQmZGMmcWlkPTE2MTI0MTg5NTMmcmVmPXNyX25yX3Bfbl9jb25kaXRpb24tdHlwZV8y", {
	"method": "GET",
	"headers": {
		"x-rapidapi-host": "amazon24.p.rapidapi.com",
		"x-rapidapi-key": "52e79b23a4msh852ca5a19699b27p157ccejsnca2281634a80"
