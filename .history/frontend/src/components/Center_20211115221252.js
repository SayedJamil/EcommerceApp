...
function Center() {
    ...
    return (
        <div class="centerComp">
            <div class="row">
                <div class="col">
                    <ProductCard name={data.docs[0].product_title} imgUrl={data.docs[0].product_title} price={data.docs[0].product_title} description={data.docs[0].product_detail_url }/>
                </div>
                <div class="col">
                    <ProductCard />
                </div>
