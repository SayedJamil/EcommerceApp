...
function Header() {
    ...
    const basket = const state = useSelector(state => state.state)(state => state.basket)
        ...
        <div>
            <nav class="navbar navbar-light navbarColor">
                <div class="container-fluid">
                    <span class="navbar-brand mb-0 h1 iconColor"><Link to="/" style={{ textDecoration: 'none', color: 'white' }}>EcommerceApp</Link></span>
                    <form class="d-flex">
                    ...
                    <div class="headerRight">
                        ...
                        <h5><Link to="/checkout" style={{ textDecoration: 'none', color: 'white' }}>({cartCount})items</Link></h5>
                        ...
                        >
                            ...
                            <Modal.Body>
                                <Form>
                                    ...
                                    <Form.Text className="text-muted">
                                        Already a user? <Button variant="link" onClick={handleRegisterShow}>SignIn</Button>.
                                    </Form.Text>
                                </Form>
                            </Modal.Body>
                            <Modal.Footer>
                        ...
                        >
                            ...
                            <Modal.Body>
                                <Form>
                                    ...
                                    <Form.Text className="text-muted">
                                        New user? <Button variant="link" onClick={handleUserShow}>Register</Button>.
                                    </Form.Text>
                                </Form>
                            </Modal.Body>
                            <Modal.Footer>
