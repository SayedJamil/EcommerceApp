            ...
            <nav class="navbar navbar-light navbarColor">
                <div class="container-fluid">
                    ...
                    <div class="headerRight">
                        ...
                        <h5>()items</h5>
                        <button><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-circle iconColor me-1" viewBox="0 0 16 16" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                        </svg>
                            <h5 data-bs-toggle="modal" data-bs-target="#exampleModal">Hello user, SignIn</h5></button>
